...
<template>
  ...
  <el-radio-group v-else-if="proxyOptions.length > 0" ref="ref" v-model="Value" v-bind="getProps($attrs, 'group')" v-on="$listeners">
  ...
  <component v-else ref="ref" :is="is" v-model="Value" v-bind="getProps($attrs)" v-on="$listeners">
